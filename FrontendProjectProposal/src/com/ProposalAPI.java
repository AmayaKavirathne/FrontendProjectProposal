...
public class ProposalAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = proposal.addProposals(request.getParameter("ProjectName"),
				request.getParameter("budget"),
				request.getParameter("CompletionDate"), 
				request.getParameter("productCategory"),
				request.getParameter("sellOrNot"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = proposal.updateProposals(paras.get("hidIDSave").toString(), 
				...
				paras.get("CompletionDate").toString(), 
				paras.get("productCategory").toString(), 
				paras.get("sellOrNot").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		Map paras = getParasMap(request);
		String output = proposal.deleteProposal(paras.get("proposal_ID").toString());
		response.getWriter().write(output);
	}
